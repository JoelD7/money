...
import {useGetCategoryExpenseSummary, useGetPeriod, useGetUser,} from "./queries.ts";
...
export function Home() {
    ...
    return (
        <Container>
            ...
            <NewTransaction type={"expense"} open={openNewExpense} onClose={handleNewExpenseClose}/>
            <NewTransaction type={"income"} open={openNewIncome} onClose={handleNewIncomeClose}/>
        </Container>
    );
}
