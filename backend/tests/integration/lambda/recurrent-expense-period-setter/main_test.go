...
func TestProcess(t *testing.T) {
	...
	result, _, err := req.ExpensesRepo.GetExpensesByPeriod(ctx, period.Username, &models.ExpenseQueryParameters{Period: period.ID, BaseQueryParameters: models.BaseQueryParameters{PageSize: 20}})
